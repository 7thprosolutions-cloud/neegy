...
import { loadRiggedCharacterAsset, instantiateRiggedCharacter, WHITE } from "/arena3d/character.js?v=37";
import { loadProfile, recordMatchResult, MODES, XP_PER_KILL, XP_PER_GAME } from "/arena3d/profile.js?v=37";
import { submitMatchResult } from "/arena3d/account.js?v=37";
import * as MP from "/arena3d/mp.js?v=37";
import { mp } from "/arena3d/mp.js?v=37";
